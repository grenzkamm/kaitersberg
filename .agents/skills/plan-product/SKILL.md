...
---
<!-- Generated from .claude/skills/plan-product/ by scripts/port-to-codex.py.
...
## Phase 2 - Clarify (a multiple-choice question, concrete options, max 3 rounds)
...
| AGENTS.md | What every session reads first: the reading list, the commands, the rules |

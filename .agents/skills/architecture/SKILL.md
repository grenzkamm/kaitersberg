...
---
<!-- Generated from .claude/skills/architecture/ by scripts/port-to-codex.py.
...
Use a multiple-choice question for the load-bearing decisions, recommendation first. For
...
1. Add `docs/architecture.md` to the project's `AGENTS.md` imports, so every
...
- [ ] Added to `AGENTS.md` imports - and to every other harness context file the repository root carries

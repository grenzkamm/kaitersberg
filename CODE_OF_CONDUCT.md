...
officially representing the community in public spaces. Examples include using an
official email address, posting via an official social media account, or acting as
an appointed representative at an event.

## Enforcement

Report abusive, harassing or otherwise unacceptable behaviour privately through
the repository's
[security advisory form](https://github.com/grenzkamm/kaitersberg/security/advisories/new).
...
Maintainers will use these Community Impact Guidelines in determining the
...
**Consequence:** A private, written warning providing clarity around the nature of
the violation and an explanation of why the behaviour was inappropriate. A public
...
community spaces and external channels such as social media. Violating these terms

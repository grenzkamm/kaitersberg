---
name: qa
description: Test one built feature against every acceptance criterion in the running system - automated levels, browser walkthrough with Codex Browser, edge cases, and an adversarial pass that attacks the feature the way a hostile user would. Writes a test report and a production-readiness verdict. Fixes nothing.
---
<!-- Generated from .claude/skills/qa/ by scripts/port-to-codex.py.
